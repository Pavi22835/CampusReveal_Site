...
const AddUniversity = () => {
  ...
  const [formData, setFormData] = useState({
    ...
    academicLevel: '',
    department: '',
    offeredCourses: [], // Array of courses
    entranceExam: '',
    ...
    <div className="add-university-page">
      ...
      <form onSubmit={handleSubmit} className="add-university-form">
        ...
        <div className="form-layout">
          <div className="form-main">
            ...
            <div className={`form-section ${activeSection === 'academic' ? 'active' : ''}`}>
              ...
              {/* NEW: Academic Stream, Level, Department */}
            ...
            <div className={`form-section ${activeSection === 'stats' ? 'active' : ''}`}>
              ...
              <div className="form-grid">
                <div className="form-group">
                  ...
                  <input type="number" name="rating" step="0.1" min="0" max="5" value={formData.rating} onChange={handleChange} />
                </div>
                <div className="form-group">
          ...
          <div className="form-sidebar">
            <div className="sidebar-card">
              ...
              <div className="image-grid">
                {previewImages.map((img, idx) => (
                  <div key={idx} className="image-item">
                    ...
                    <button type="button" onClick={() => removeImage(idx)}><X size={14} /></button>
                  </div>
                ))}
              ...
              <p className="image-hint">{5 - previewImages.length} images remaining</p>
            </div>
            ...
            <div className="sidebar-card preview-card">
              ...
              <div className="preview-image-wrap">
                {previewImages[0] ? (
                  <img src={previewImages[0]} alt="Preview cover" />
                ) : (
        ...
        <div className="form-actions">
          ...
          {!isFirstSection && (
            <button type="button" onClick={prevSection} className="secondary-btn">
              Previous
            </button>
          )}
          {isLastSection ? (
