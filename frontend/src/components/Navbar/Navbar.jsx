...
export default function Navbar() {
  ...
  const handleProfileSuccess = () => {
    // After profile details are saved, navigate to write review
    navigate('/write-review');
  };
            ...
            <>
              ...
              >
                ...
                <div className="flex-1 py-6 px-5 space-y-1">
                  ...
                  {/* Write a Review Button in Mobile Menu */}
                  <button
                    onClick={() => {
                      handleWriteReview();
                      setShowMobileMenu(false);
                    }}
                    className="w-full px-4 py-3 bg-emerald-600 text-white rounded-xl font-bold text-sm hover:bg-emerald-500 transition-colors flex items-center justify-center gap-2"
                  >
                    <Edit3 size={18} />
                    Write a Review
                  </button>
